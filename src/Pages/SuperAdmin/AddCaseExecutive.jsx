...
const AddCaseExecutive = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      await set(ref(db, `settings/case_executives/${key}`), { name: nm, createdAt: Date.now() })
      setStatus('Saved')
      setName('')
    } catch (err) {
  ...
  return (
    <div className="max-w-xl mx-auto">
      <h3 className="text-2xl font-bold text-gray-800 mb-4">Add Case Executive</h3>
...
export default AddCaseExecutive
